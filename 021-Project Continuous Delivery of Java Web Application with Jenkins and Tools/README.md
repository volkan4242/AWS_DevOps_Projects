# Project-21: Continuous Delivery with Jenkins and Tools
...
```sh
git clone -b ci-jenkins git@github.com:volkan42/vprofileproject-all.git
```
...
sudo -i
sudo su - jenkins
git ls-remote -h -- git@github.com:volkan42/vprociproject.git HEAD
```
...
```sh
https://github.com/volkan42/vprofileproject-all.git
```
...
![](images/ecs-cluster-3.png)


![](images/ecs-cluster-4.png)


![](images/ecs-cluster-5.png)


![](images/ecs-cluster-6.png)


![](images/ecs-cluster-7.png)


![](images/ecs-cluster-8.png)


![](images/ecs-cluster-9.png)
