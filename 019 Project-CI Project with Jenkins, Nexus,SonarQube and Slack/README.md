# Project-019: Continuous Integration Using jenkins, Nexus, Sonarqube and Slack
...
![](images/jenkins-sg.png)

![](images/jenkins-sg-1.png)

![](images/jenkins-sg-2.png)
...
![](images/jenkins-server-2.png)

![](images/jenkins-server-3.png)

![](images/jenkins-server-4.png)
...
![](images/nexus-server.png)

![](images/nexus-server-2.png)

![](images/nexus-server-3.png)
...
![](images/sonar-server-2.png)

![](images/sonar-server-3.png)

![](images/sonar-server-4.png)
...
```sh
git clone -b ci-jenkins git@github.com:volkan4242/vprofileproject-all.git
```
...
sudo -i
sudo su - jenkins
git ls-remote -h -- git@github.com:volkan4242/vprociproject.git HEAD
```
